...
export default function PrivacyPage() {
  ...
  const getStatusBadge = (status: string) => {
    ...
    return (
      <span className={`px-2 py-1 text-xs font-medium rounded-full ${styles[status] || 'bg-muted'}`}>
        {status}
      </span>
    )
  }
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Manage your data and account settings.</p>
      </div>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          {exportRequests.length > 0 && (
            <div className="mt-4">
              <h4 className="text-sm font-medium text-foreground mb-2">Recent Export Requests</h4>
            ...
            <div className="bg-red-50 dark:bg-red-950 border border-red-200 dark:border-red-800 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="font-medium text-red-800 dark:text-red-200">Account Deletion Scheduled</p>
                  ...
                  <Button
                    variant="outline"
                    className="mt-4 border-red-300 dark:border-red-700 text-red-700 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-950"
